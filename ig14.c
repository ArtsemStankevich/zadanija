//Напиши структуру-базу данных для хранения всех студентов, преподавателей  уг. Напиши функцию для добавления, удаление, редактировать + сохранение в Бин и тхт
